...
echo "=== Spark Structured Streaming Processing POC ==="

echo "Cleaning up previous checkpoints..."
rm -rf /tmp/spark-checkpoints/city-sales /tmp/spark-checkpoints/salesman-sales
...
echo "Starting Spark processor in background..."
mvn -q compile exec:java -Dexec.mainClass="com.sales.SparkProcessor" &
PROCESSOR_PID=$!
